...
public class PriceService {
    ...
    public BigDecimal calcolaPrezzoFinale(Product product, PriceSettings settings) {
        ...
        // Aumento per fornitore
        Supplier fornitore = product.getFornitore();
        if (fornitore != null && fornitore.getAumentoPercentuale() != null) {
            return applica(base, fornitore.getAumentoPercentuale());
        }
